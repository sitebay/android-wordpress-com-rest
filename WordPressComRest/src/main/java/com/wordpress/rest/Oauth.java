...
public class Oauth {
    ...
    public static final String AUTHORIZE_ENDPOINT = "https://my.sitebay.org/f/api/v1/mobile/oauth2/authorize";
    private static final String AUTHORIZED_ENDPOINT_FORMAT = "%s?client_id=%s&redirect_uri=%s&response_type=code";

    public static final String TOKEN_ENDPOINT = "https://my.sitebay.org/f/api/v1/mobile/oauth2/token";
