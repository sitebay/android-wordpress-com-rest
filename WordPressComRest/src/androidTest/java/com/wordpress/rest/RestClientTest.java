...
public class RestClientTest extends AndroidTestCase {
    public void testGetAbsoluteURLWithLeadingSlash() {
        ...
        String expected = String.format("https://my.sitebay.org/f/api/v1/mobile/rest/v1%s", path);
    ...
    public void testRestClientGetAbsoluteURLWithParameters() {
        ...
        String expected = "https://my.sitebay.org/f/api/v1/mobile/rest/v1/test?a=1&b=c";
        assertEquals(expected, url);
    }
}
